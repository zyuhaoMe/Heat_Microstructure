...
class MultiTrackLaserClass: public LaserClass{
  public:
    ...
    // calculate the laser information,
    // including: position, speed, current laser state
    // and current index of laser based upon the give time value
    void calLaserInfoMultiLine(
         double &laserPositionX,
         double &laserPositionY,
         double &speed,
