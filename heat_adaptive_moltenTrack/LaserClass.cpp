...
bool LaserClass::calLaserPositionMultiLine(
  ...
  cout << "Virtual function calLaserPositionMultiLine has not been overwritten! " << endl;
  exit(3);
  return false;
}
...
bool LaserClass::calLaserSpeedMultiLine(
  ...
  cout << "Virtual function calLaserSpeedMultiLine has not been overwritten! " << endl;
  exit(3);
  return false;
}
